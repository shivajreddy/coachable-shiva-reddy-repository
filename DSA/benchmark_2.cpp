...
// Everything should be implemented in O(1) worst-case runtime using a singly linked list to implement it.
// If you have questions about the requirements you can ask me.
struct Stack {
 private:
};
